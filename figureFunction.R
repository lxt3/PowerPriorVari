...
# KS 1sided
load(fname.reg.KS1)
results.alpha.KS1side<-results.alpha.wb  # alpha
results.prob.dropF.KS1side<-results.prob.dropF.wb  # type I error without dropping
results.prob.dropT.KS1side<-results.prob.dropT.wb

# make room for KS2 (for safety)
rm(results.prob.dropF.wb, results.prob.dropT.wb,results.alpha.wb)
...
# SO 1-sided
load(fname.reg.Ord1)
results.alpha.SO1side<-results.alpha.wbord
...
# make room for SO2
rm(results.alpha.wbord,results.prob.dropF.wbord,results.prob.dropT.wbord)


# SO 2-sided
load(fname.reg.Ord2)
results.alpha.SO2side<-results.alpha.wbord
